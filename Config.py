...
if ENVIRONMENT:
    ...
    BOT_TOKEN = "6721031289:AAF2orQmnkkSCJC7Rp7-fSehRaezexSRNtE"
    DATABASE_URL = "postgres://irnfieon:K-F9J_rI1BgfI9tsoVU_jZ1NvmfABWLF@berry.db.elephantsql.com/irnfieon"
